...
video_list.each do |title, description, category|
  Video.create!(
    ...
    large_cover: File.open(File.join(Rails.root, "/public/tmp/#{title.downcase.tr(' ', '_')}_large.jpg")),
    small_cover: File.open(File.join(Rails.root, "/public/tmp/#{title.downcase.tr(' ', '_')}.jpg")),
    category: category
  )
end
...
the_office = Video.create!(
  ...
  small_cover: File.open(File.join(Rails.root, '/public/tmp/office.jpg')),
  large_cover: File.open(File.join(Rails.root, '/public/tmp/office_large.jpg')),
  category: comedy
)
...
the_amazing_race = Video.create!(
  ...
  small_cover: File.open(File.join(Rails.root, '/public/tmp/amazing_race.jpg')),
  large_cover: File.open(File.join(Rails.root, '/public/tmp/amazing_race_large.jpg')),
  category: reality
)
